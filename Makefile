...
PROJECT_NAME ?= provider-jfrog-project
PROJECT_REPO ?= github.com/mikegio27/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_SOURCE ?= jfrog/project
export TERRAFORM_PROVIDER_REPO ?= https://github.com/jfrog/terraform-provider-project
export TERRAFORM_PROVIDER_VERSION ?= 1.9.6
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-project
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-project_v1.9.6
...
xpkg.build.provider-jfrog-project: do.build.images
